...
public interface Resolvables {
    ...
    static final Resolvables instance = ServiceLoader.load(Resolvables.class).findFirst().orElseThrow(() -> new IllegalStateException("Cannot find the quinimbus core library, is it on the classpath / modulepath?"));
