...
public class CreationContext implements Resolver {
    ...
    private final ThrowingMap<String, BufferedImage, BinaryResolutionException> loadedImages =
            ThrowingMap.empty(BinaryResolutionException.class);

    private final ThrowingMap<String, Font, BinaryResolutionException> loadedFonts =
            ThrowingMap.empty(BinaryResolutionException.class);
